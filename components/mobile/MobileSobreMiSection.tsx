...
Valoro la colaboración y el trabajo en equipo, porque las mejores soluciones nacen del intercambio de ideas y perspectivas diversas.`,
  ...
  return (
    <div className="mobile-sobremi-layout mobile-section-container mobile-scroll-container">
      <div className="mobile-content-area mobile-safe-top mobile-safe-horizontal">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        ...
        >
          ...
          <p 
            className="text-base mobile-text-base"
            style={{ color: 'var(--text-200)' }}
          >
        ...
        <motion.div
          ...
          className="flex bg-opacity-10 rounded-xl p-1 mobile-glass-enhanced"
          style={{
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`flex-1 py-3 px-2 rounded-lg transition-all duration-300 mobile-touch-target ${
        ...
        <div className="flex-1 overflow-hidden mobile-touch-scroll">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="h-full overflow-y-auto custom-scroll mobile-fade-in"
            >
              {renderTabContent()}
            </motion.div>
          </AnimatePresence>
        ...
        <motion.div
          ...
          className="grid grid-cols-3 gap-4 mobile-safe-bottom"
        >
          <div
            className="text-center p-3 rounded-lg border mobile-glass-enhanced"
            style={{
              background: 'rgba(173, 153, 27, 0.05)',
              borderColor: 'rgba(173, 153, 27, 0.2)'
            }}
